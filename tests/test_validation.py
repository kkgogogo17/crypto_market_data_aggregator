...
from src.main import validate_date_format, fetch_crypto_data_endpoint
...
class TestFetchCryptoDataEndpointValidation:
    ...
    def test_date_range_validation_start_after_end(self):
        ...
        result = fetch_crypto_data_endpoint("BTCUSD", start_date="2024-01-02", end_date="2024-01-01")
    ...
    def test_date_range_validation_equal_dates(self):
        ...
        with patch.dict(os.environ, {}, clear=True):
            with pytest.raises(ValueError, match="TIINGO_TOKEN environment variable is not set"):
                fetch_crypto_data_endpoint("BTCUSD", start_date="2024-01-01", end_date="2024-01-01")
    ...
    def test_valid_parameters_no_api_token(self):
        ...
        with patch.dict('os.environ', {}, clear=True):
            ...
            # Test date range
            with pytest.raises(ValueError, match="TIINGO_TOKEN environment variable is not set"):
                fetch_crypto_data_endpoint("BTCUSD", start_date="2024-01-01", end_date="2024-01-02")
